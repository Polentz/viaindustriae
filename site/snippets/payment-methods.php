...
<div class="radio-wrapper">
  ...
  <?php foreach(collection('payment-methods') as $paymentMethod): ?>
    ...
    ?>
      <div class="field text-subtitle" data-type="radio">
        <input
          <?= Html::attr([
            'type' => 'radio',
            'name' => 'paymentMethod',
  ...
  <?php if (!empty($stripePublishableKey) && collection('payment-methods')->has('credit-card')): ?>
    <div class="field" data-payment-method="credit-card-sca" hidden>
      <label for="">
  ...
  <?php if (!empty($stripePublishableKey) && collection('payment-methods')->has('sepa-debit')): ?>
    <div class="field" data-payment-method="sepa-debit" hidden>
      <label for="">
